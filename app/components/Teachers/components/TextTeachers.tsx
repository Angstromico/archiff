  ...
  return (
    <div className='flex flex-col gap-3 lg:flex-row lg:justify-between relative'>
      <SectionLogo
        ...
        alt='Profesores'
      />
      <div className='w-full max-w-[973px] border-2 border-b-0 lg:border-3 lg:border-b-0 px-3 lg:pl-8 lg:pb-0 text-[23px] lg:text-[30px]'>
        <p className='w-full max-w-[600px] text-justify md:mt-14'>
